    ...
    for sql in sql_list:
        ...
        for t in count():
            ...
            if done:
                ...
                print("ordre cost",reward,"pgadmin",pg_cost)
    ...
    for idx in range(len(sql_list)):
        ...
        for ts in range(len(sql_list)):
            ...
            if rd<0:
                ...
                break
    print("ccccccccccc",len(res_sql+sql_list))
...
def train(trainSet,validateSet):
    ...
    for i_episode in range(0,10000):
        ...
        #print("queryyyyyy",sqlt,'with cost :', pg_cost)
        ...
        for t in count():
            ...
            if done:
                ...
                #             print("done")
                next_value = 0
                #print('ordeeeeer',action_this_epi)
